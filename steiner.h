...
struct full_set {
	...
	int			tree_num;
	dist_t			tree_len;
	double battery_score;    /* PSW: sum of battery levels for terminals */
	int *			tlist;
...
struct gst_hypergraph {
	...
	// double *        battery_score;  /* <-- PSW: Battery score for each edge */
	...
	/* PSW: Global normalization constants for multi-objective optimization */
	double			max_edge_len;		/* Maximum individual edge length across all FSTs */
	double			max_fst_cost;		/* Maximum FST cost across all FSTs */
	double			max_battery_cost;	/* Maximum battery cost across all terminals */
