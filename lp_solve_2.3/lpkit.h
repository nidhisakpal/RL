...
#define DEF_EPSB      1e-5 /* for rounding RHS values to 0 determine
				 infeasibility basis (relaxed for stability) */
#define DEF_EPSEL     1e-6 /* for rounding other values (vectors) to 0 (relaxed) */
#define DEF_EPSD      1e-4 /* for rounding reduced costs to zero (relaxed) */
#define DEF_EPSILON   1e-2 /* to determine if a float value is integer (relaxed) */
